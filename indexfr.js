  ...
  function shareOnWhatsApp() {
    ...
    let message = `Hello`;
      ...
      if (senderCountry === "GHANA") {
        message = ` Expéditeur: ${senderMmNumber} (${senderNetwork}) ${senderCountry}
      Bénéficiaire: ${receiverMmNumber} (${receiverNetwork}) ${receiverCountry}\n
      Montant: ${sendAmount.toFixed(2)} GHS | Frais: ${transactionFee.toFixed(2)} GHS |
      Total: ${totalAmount.toFixed(2)} GHS | Montant à recevoir: ${amountToReceive.toFixed(0)} FCFA`;
      }
  
      else if (senderCountry !== "GHANA") {
        message = ` Expéditeur: ${senderMmNumber} (${senderNetwork}) ${senderCountry}
      Bénéficiaire: ${receiverMmNumber} (${receiverNetwork}) ${receiverCountry}\n
      Montant: ${sendAmount} FCFA | Frais: ${transactionFee} FCFA |
      Total: ${totalAmount} FCFA | Montant à recevoir: ${amountToReceive.toFixed(0)} GHS`;
      }
